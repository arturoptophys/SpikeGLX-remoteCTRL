...
dict_items([('gateMode', '0'), ('manOvConfirm', 'false'), ('manOvInitOff', 'true'), ('manOvShowBut', 'true'),
            ('niAiRangeMax', '2'), ('niAiRangeMin', '-2'), ('niAiTermConfig', '-1'), ('niClockLine1', 'Internal'),
            ('niClockLine2', 'PFI2'), ('niClockSource', ''), ('niDev1', ''), ('niDev2', ''), ('niDualDevMode', 'false'),
            ('niEnabled', 'false'), ('niMAChans1', ''), ('niMAChans2', '6,7'), ('niMAGain', '1'), ('niMNChans1', ''),
            ('niMNChans2', '0:5'), ('niMNGain', '200'), ('niMuxFactor', '32'), ('niSettle', '7'),
            ('niSnsChanMapFile', ''), ('niSnsSaveChanSubset', 'all'), ('niSnsShankMapFile', ''),
            ('niStartEnable', 'false'), ('niStartLine', ''), ('niXAChans1', '0:7'), ('niXAChans2', ''),
            ('niXDChans1', '0:7'), ('niXDChans2', ''), ('snsFldPerProbe', 'true'), ('snsNotes', ''),
            ('snsPairChk', 'true'), ('snsReqMins', '10'), ('snsRunName', 'myRun'), ('syncCalMins', '20'),
            ('syncImInputSlot', '2'), ('syncNiChan', '0'), ('syncNiChanType', '0'), ('syncNiThresh', '1.1'),
            ('syncSourceIdx', '0'), ('syncSourcePeriod', '1'), ('trgSpikeAIChan', '4'), ('trgSpikeInarow', '3'),
            ('trgSpikeIsNInf', 'false'), ('trgSpikeNS', '10'), ('trgSpikePeriEvtS', '1'), ('trgSpikeRefractS', '0.5'),
            ('trgSpikeStream', 'nidq'), ('trgSpikeThresh', '-0.0001'), ('trgTTLAIChan', '4'), ('trgTTLBit', '0'),
            ('trgTTLInarow', '5'), ('trgTTLIsAnalog', 'true'), ('trgTTLIsNInf', 'true'), ('trgTTLMarginS', '1'),
            ('trgTTLMode', '0'), ('trgTTLNH', '10'), ('trgTTLRefractS', '0.5'), ('trgTTLStream', 'nidq'),
            ('trgTTLTH', '0.5'), ('trgTTLThresh', '1.1'), ('trgTimIsHInf', 'false'), ('trgTimIsNInf', 'false'),
            ('trgTimNH', '3'), ('trgTimTH', '10'), ('trgTimTL', '1'), ('trgTimTL0', '10'), ('trigMode', '0')])
#c_sglx_getParamsImecCommon
dict_items([('imBistAtDetect', 'true'), ('imCalPolicy', '0'), ('imEnabled', 'true'), ('imLowLatency', 'false'), 
('imNProbes', '1'), ('imQfHiCut', 'INF'), ('imQfLoCut', '0'), ('imQfOn', 'true'), ('imQfSecs', '.5'),
